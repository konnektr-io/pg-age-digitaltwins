...
Before you can interact with your Graph API, you'll need to authenticate. See the [Authentication Guide](./authentication) for detailed instructions on obtaining and using access tokens.
...
- **Self-Hosted**: Need full control? Check our [self-hosted deployment guide](../deployment-installation/self-host)
- **Migration**: Coming from Azure Digital Twins? See our [migration guide](../how-to-guides/migration-guide)
