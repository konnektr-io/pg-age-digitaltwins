...
// Re-export the shared Permission class
public sealed class Permission : ServiceDefaults.Authorization.Models.Permission
{
    public Permission(ResourceType resource, PermissionAction action) : base(resource, action)
    {
    }
}
...
#if FALSE
/// <summary>
/// This class has been moved to ServiceDefaults for sharing between projects.
/// </summary>
{
    /// <summary>
